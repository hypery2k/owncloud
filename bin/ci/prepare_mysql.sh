...
cat /var/www/roundcubemail-0.7.3/SQL/mysql.initial.sql | mysql -uroot roundcubemail_073
...
cat  /var/www/roundcubemail-0.8.2/SQL/mysql.initial.sql | mysql -uroot roundcubemail_082
