...
?>
<form id="storage-charts" method="POST" action="<?php print(OC_Helper::linkTo('settings','personal.php')); ?>">
	<fieldset class="personalblock">
		...
		<?php foreach($_['displays'] as $chart => $is_enable){
			...
			<div><input type="checkbox" name="storage-charts_disp[]" id="<?php print($chart); ?>_e" style="margin-right:10px;"<?php print($is_enable?' checked':'') ?> value="<?php print($chart); ?>" /><?php print($l->t($chart_title)); ?></div>
		<?php } ?>
