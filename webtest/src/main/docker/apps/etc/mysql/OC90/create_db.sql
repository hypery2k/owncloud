...
--
-- Table structure for table `oc9_activity`
--

CREATE TABLE IF NOT EXISTS `oc9_activity` (
...
--
-- Dumping data for table `oc9_activity`
--

INSERT INTO `oc9_activity` (`activity_id`, `timestamp`, `priority`, `type`, `user`, `affecteduser`, `app`, `subject`, `subjectparams`, `message`, `messageparams`, `file`, `link`, `object_type`, `object_id`) VALUES
...
--
-- Table structure for table `oc9_activity_mq`
--

CREATE TABLE IF NOT EXISTS `oc9_activity_mq` (
...
--
-- Table structure for table `oc9_appconfig`
--

CREATE TABLE IF NOT EXISTS `oc9_appconfig` (
...
--
-- Dumping data for table `oc9_appconfig`
--

INSERT INTO `oc9_appconfig` (`appid`, `configkey`, `configvalue`) VALUES
...
--
-- Table structure for table `oc9_filecache`
--

CREATE TABLE IF NOT EXISTS `oc9_filecache` (
...
--
-- Dumping data for table `oc9_filecache`
--

INSERT INTO `oc9_filecache` (`fileid`, `storage`, `path`, `path_hash`, `parent`, `name`, `mimetype`, `mimepart`, `size`, `mtime`, `storage_mtime`, `encrypted`, `unencrypted_size`, `etag`, `permissions`) VALUES
...
--
-- Table structure for table `oc9_files_trash`
--

CREATE TABLE IF NOT EXISTS `oc9_files_trash` (
...
--
-- Table structure for table `oc9_file_locks`
--

CREATE TABLE IF NOT EXISTS `oc9_file_locks` (
...
--
-- Dumping data for table `oc9_file_locks`
--

INSERT INTO `oc9_file_locks` (`id`, `lock`, `key`, `ttl`) VALUES
...
--
-- Table structure for table `oc9_file_map`
--

CREATE TABLE IF NOT EXISTS `oc9_file_map` (
...
--
-- Table structure for table `oc9_groups`
--

CREATE TABLE IF NOT EXISTS `oc9_groups` (
  `gid` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Dumping data for table `oc9_groups`
--

INSERT INTO `oc9_groups` (`gid`) VALUES
('admin');

-- --------------------------------------------------------

--
-- Table structure for table `oc9_group_admin`
--

CREATE TABLE IF NOT EXISTS `oc9_group_admin` (
  `gid` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `oc9_group_user`
--

CREATE TABLE IF NOT EXISTS `oc9_group_user` (
  `gid` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
  `uid` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Dumping data for table `oc9_group_user`
--

INSERT INTO `oc9_group_user` (`gid`, `uid`) VALUES
('admin', 'admin');

-- --------------------------------------------------------

--
-- Table structure for table `oc9_jobs`
--

CREATE TABLE IF NOT EXISTS `oc9_jobs` (
`id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `oc9_jobs`
--

INSERT INTO `oc9_jobs` (`id`, `class`, `argument`, `last_run`) VALUES
...
--
-- Table structure for table `oc9_mimetypes`
--

CREATE TABLE IF NOT EXISTS `oc9_mimetypes` (
`id` int(11) NOT NULL,
  `mimetype` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT ''
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Dumping data for table `oc9_mimetypes`
--

INSERT INTO `oc9_mimetypes` (`id`, `mimetype`) VALUES
(3, 'application'),
...
--
-- Table structure for table `oc9_preferences`
--

CREATE TABLE IF NOT EXISTS `oc9_preferences` (
...
--
-- Dumping data for table `oc9_preferences`
--

INSERT INTO `oc9_preferences` (`userid`, `appid`, `configkey`, `configvalue`) VALUES
...
--
-- Table structure for table `oc9_privatedata`
--

CREATE TABLE IF NOT EXISTS `oc9_privatedata` (
...
--
-- Table structure for table `oc9_properties`
--

CREATE TABLE IF NOT EXISTS `oc9_properties` (
`id` int(11) NOT NULL,
  `userid` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `oc9_roundcube`
--

CREATE TABLE IF NOT EXISTS `oc9_roundcube` (
...
--
-- Dumping data for table `oc9_roundcube`
--

INSERT INTO `oc9_roundcube` (`id`, `oc_user`, `mail_user`, `mail_password`) VALUES
...
--
-- Table structure for table `oc9_share`
--

CREATE TABLE IF NOT EXISTS `oc9_share` (
`id` int(11) NOT NULL,
...
--
-- Table structure for table `oc9_share_external`
--

CREATE TABLE IF NOT EXISTS `oc9_share_external` (
`id` int(11) NOT NULL,
...
--
-- Table structure for table `oc9_storagecharts2`
--

CREATE TABLE IF NOT EXISTS `oc9_storagecharts2` (
...
--
-- Dumping data for table `oc9_storagecharts2`
--

INSERT INTO `oc9_storagecharts2` (`stc_id`, `oc_uid`, `stc_month`, `stc_dayts`, `stc_used`, `stc_total`) VALUES
...
--
-- Table structure for table `oc9_storagecharts2_uconf`
--

CREATE TABLE IF NOT EXISTS `oc9_storagecharts2_uconf` (
...
--
-- Dumping data for table `oc9_storagecharts2_uconf`
--

INSERT INTO `oc9_storagecharts2_uconf` (`uc_id`, `oc_uid`, `uc_key`, `uc_val`) VALUES
(1, 'admin', 'hu_size', '3'),
...
--
-- Table structure for table `oc9_storages`
--

CREATE TABLE IF NOT EXISTS `oc9_storages` (
...
--
-- Dumping data for table `oc9_storages`
--

INSERT INTO `oc9_storages` (`id`, `numeric_id`, `available`, `last_checked`) VALUES
('home::admin', 1, 1, NULL),
...
--
-- Table structure for table `oc9_users`
--

CREATE TABLE IF NOT EXISTS `oc9_users` (
  `uid` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Dumping data for table `oc9_users`
--

INSERT INTO `oc9_users` (`uid`, `displayname`, `password`) VALUES
...
--
-- Table structure for table `oc9_vcategory`
--

CREATE TABLE IF NOT EXISTS `oc9_vcategory` (
`id` int(10) unsigned NOT NULL,
  `uid` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `oc9_vcategory_to_object`
--

CREATE TABLE IF NOT EXISTS `oc9_vcategory_to_object` (
...
--
-- Indexes for table `oc9_activity`
--
ALTER TABLE `oc9_activity`
...
--
-- Indexes for table `oc9_activity_mq`
--
ALTER TABLE `oc9_activity_mq`
...
--
-- Indexes for table `oc9_appconfig`
--
ALTER TABLE `oc9_appconfig`
 ADD PRIMARY KEY (`appid`,`configkey`), ADD KEY `appconfig_config_key_index` (`configkey`), ADD KEY `appconfig_appid_key` (`appid`);

--
-- Indexes for table `oc9_filecache`
--
ALTER TABLE `oc9_filecache`
...
--
-- Indexes for table `oc9_files_trash`
--
ALTER TABLE `oc9_files_trash`
 ADD PRIMARY KEY (`auto_id`), ADD KEY `id_index` (`id`), ADD KEY `timestamp_index` (`timestamp`), ADD KEY `user_index` (`user`);

--
-- Indexes for table `oc9_file_locks`
--
ALTER TABLE `oc9_file_locks`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `lock_key_index` (`key`), ADD KEY `lock_ttl_index` (`ttl`);

--
-- Indexes for table `oc9_file_map`
--
ALTER TABLE `oc9_file_map`
 ADD PRIMARY KEY (`logic_path_hash`), ADD UNIQUE KEY `file_map_pp_index` (`physic_path_hash`);

--
-- Indexes for table `oc9_groups`
--
ALTER TABLE `oc9_groups`
 ADD PRIMARY KEY (`gid`);

--
-- Indexes for table `oc9_group_admin`
--
ALTER TABLE `oc9_group_admin`
 ADD PRIMARY KEY (`gid`,`uid`), ADD KEY `group_admin_uid` (`uid`);

--
-- Indexes for table `oc9_group_user`
--
ALTER TABLE `oc9_group_user`
 ADD PRIMARY KEY (`gid`,`uid`), ADD KEY `gu_uid_index` (`uid`);

--
-- Indexes for table `oc9_jobs`
--
ALTER TABLE `oc9_jobs`
 ADD PRIMARY KEY (`id`), ADD KEY `job_class_index` (`class`);

--
-- Indexes for table `oc9_mimetypes`
--
ALTER TABLE `oc9_mimetypes`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `mimetype_id_index` (`mimetype`);

--
-- Indexes for table `oc9_preferences`
--
ALTER TABLE `oc9_preferences`
 ADD PRIMARY KEY (`userid`,`appid`,`configkey`);

--
-- Indexes for table `oc9_privatedata`
--
ALTER TABLE `oc9_privatedata`
 ADD PRIMARY KEY (`keyid`);

--
-- Indexes for table `oc9_properties`
--
ALTER TABLE `oc9_properties`
 ADD PRIMARY KEY (`id`), ADD KEY `property_index` (`userid`);

--
-- Indexes for table `oc9_roundcube`
--
ALTER TABLE `oc9_roundcube`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `oc9_share`
--
ALTER TABLE `oc9_share`
...
--
-- Indexes for table `oc9_share_external`
--
ALTER TABLE `oc9_share_external`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `sh_external_mp` (`user`,`mountpoint_hash`), ADD KEY `sh_external_user` (`user`);

--
-- Indexes for table `oc9_storagecharts2`
--
ALTER TABLE `oc9_storagecharts2`
 ADD PRIMARY KEY (`stc_id`);

--
-- Indexes for table `oc9_storagecharts2_uconf`
--
ALTER TABLE `oc9_storagecharts2_uconf`
 ADD PRIMARY KEY (`uc_id`);

--
-- Indexes for table `oc9_storages`
--
ALTER TABLE `oc9_storages`
 ADD PRIMARY KEY (`numeric_id`), ADD UNIQUE KEY `storages_id_index` (`id`);

--
-- Indexes for table `oc9_users`
--
ALTER TABLE `oc9_users`
 ADD PRIMARY KEY (`uid`);

--
-- Indexes for table `oc9_vcategory`
--
ALTER TABLE `oc9_vcategory`
 ADD PRIMARY KEY (`id`), ADD KEY `uid_index` (`uid`), ADD KEY `type_index` (`type`), ADD KEY `category_index` (`category`);

--
-- Indexes for table `oc9_vcategory_to_object`
--
ALTER TABLE `oc9_vcategory_to_object`
...
--
-- AUTO_INCREMENT for table `oc9_activity`
--
ALTER TABLE `oc9_activity`
MODIFY `activity_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `oc9_activity_mq`
--
ALTER TABLE `oc9_activity_mq`
MODIFY `mail_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `oc9_filecache`
--
ALTER TABLE `oc9_filecache`
MODIFY `fileid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=47;
--
-- AUTO_INCREMENT for table `oc9_files_trash`
--
ALTER TABLE `oc9_files_trash`
MODIFY `auto_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `oc9_file_locks`
--
ALTER TABLE `oc9_file_locks`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `oc9_jobs`
--
ALTER TABLE `oc9_jobs`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `oc9_mimetypes`
--
ALTER TABLE `oc9_mimetypes`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=25;
--
-- AUTO_INCREMENT for table `oc9_privatedata`
--
ALTER TABLE `oc9_privatedata`
MODIFY `keyid` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `oc9_properties`
--
ALTER TABLE `oc9_properties`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `oc9_roundcube`
--
ALTER TABLE `oc9_roundcube`
MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `oc9_share`
--
ALTER TABLE `oc9_share`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `oc9_share_external`
--
ALTER TABLE `oc9_share_external`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `oc9_storagecharts2`
--
ALTER TABLE `oc9_storagecharts2`
MODIFY `stc_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `oc9_storagecharts2_uconf`
--
ALTER TABLE `oc9_storagecharts2_uconf`
MODIFY `uc_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `oc9_storages`
--
ALTER TABLE `oc9_storages`
MODIFY `numeric_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `oc9_vcategory`
--
ALTER TABLE `oc9_vcategory`
